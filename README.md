...
### FAQ: - if modulator process terminates with an illegal machine instruction on your CPU, you must build liquid-dsp with the option cmake -DENABLE_SIMD=OFF in the build_liquiddsp.sh 
